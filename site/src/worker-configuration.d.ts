/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: a6318eff762931b83847e567b4a13038)
// Runtime types generated with workerd@1.20250823.0 2025-08-30 nodejs_als
declare namespace Cloudflare {
	interface Env {
		CACHE: KVNamespace;
		VITE_USE_MOCK_DATA: string;
		VITE_MOCK_EVENTS: string;
		VITE_MOCK_CONTROLLERS: string;
		DATABASE_URL: string;
		DB: D1Database;
		ASSETS: Fetcher;
	}
